...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapMutations('m_cart', ['updateAllGoodsState','addOrder']),
      ...
      async payOrder() {
        ...
        // 新增一些商品属性，图片，名称
        res.message.goods = orderInfo.goods
        // 订单总数
        res.message.checkedCount = this.checkedCount
        //存储订单信息到本地
        ...
        // console.log(payInfo);
        uni.navigateTo({
          url:'/subpkg/goods_pay/goods_pay?payInfo=' + payInfo
        })
    ...
    computed: {
      ...
      ...mapState('m_cart', ['cart','goods_order']),
      // 2. 是否全选
      isFullCheck() {
